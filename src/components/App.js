...
class App extends Component {
  ...
  async loadBlockchainData() {
    ...
    // it will set the current account to navbar
    ...
    // load daiToken
    const daiTokenData = DaiToken.networks[ networkId ] ; // fetch the address
    ...
    // load DappToken
    const dappTokenData = DappToken.networks[ networkId ] ; // fetch the address
  ...
  // load web3 to connect the app to the blockchain
  async loadWeb3() {
    if( window.ethereum ) {
